...
<style>
    ...
    .hero-globe-background::after { content:""; position:absolute; inset:0; z-index:2; pointer-events:none; background:linear-gradient(90deg,rgba(7,13,29,.92) 0%,rgba(7,13,29,.72) 22%,rgba(7,13,29,.18) 52%,rgba(7,13,29,.08) 100%),linear-gradient(180deg,rgba(7,13,29,.25) 0%,transparent 28%,rgba(7,13,29,.5) 100%); }
